...
Source0  : https://cran.r-project.org/src/contrib/bindrcpp_0.2.3.tar.gz
...
%setup -q -n bindrcpp
pushd ..
cp -a bindrcpp buildavx2
popd
pushd ..
cp -a bindrcpp buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737135592
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/bindrcpp/libs/bindrcpp.so
/V4/usr/lib64/R/library/bindrcpp/libs/bindrcpp.so
